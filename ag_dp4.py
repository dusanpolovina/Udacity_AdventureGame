...
def item_choices(items, villain_choice):
    ...
    if choice5 == "1" or "take the axe" in choice5:
        item_swap(items, villain_choice, "axe")
    elif choice5 == "2" or "take the rake" in choice5:
        item_swap(items, villain_choice, "rake")
    elif choice5 == "3" or "take the enchanted blade" in choice5:
        item_swap(items, villain_choice, "enchanted blade")
    elif (
        choice5 == "4" or 
        "go back to the forked path" in choice5 or 
        "leave" in choice5
    ):
...
def play_again():
    ...
    if choice_again == "y" or choice_again == "yes":
        print_pause("Great, let's adventure again!")
        play_game()
    elif choice_again == "n" or choice_again == "no":
